...
export default function middleware(req: NextRequest) {
  ...
  // NextAuth v5 JWT cookie — HTTP or HTTPS variant
  const token =
  ...
  // Detect locale: saved cookie first, then Accept-Language header
  ...
  // Persist detected locale in cookie if not already saved (first visit)
